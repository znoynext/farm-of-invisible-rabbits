export const navigationItems = [
  ...
  },
  {
    ...
    title: "Модель оценки",
    description:
      "Настройте, как система интерпретирует наблюдения с фермы.",
  },
  {
    id: "ai-worklog",
    label: "Работа с ИИ",
    eyebrow: "Открытый процесс",
    title: "Как я работал с ИИ",
    description:
      "Отобранные решения, найденные проблемы, изменения и выполненные проверки без скрытых рассуждений.",
  },
] as const;
